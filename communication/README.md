...
If the devices cannot communicate, allow UDP ports `45859-45860`.

Run on both devices with Administrator permission:
...
Device A should print something similar to:
